...
6. Upgrade CPD services (datastage_ent_plus,ws_pipelines)
7. Apply hotfixes (CCS, Pipelines, DataStage)
...
## 7. Apply patches (DataStage Hotfixes):
...
## 9. Upgrade privileged monitors (est. 2 minutes)
