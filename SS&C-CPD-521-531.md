...
### Apply the [IBM Knowledge Catalog 5.3.1 Patch](https://www.ibm.com/support/pages/node/7254566#online-hotfix)
...
2       	Thu Jan  8 17:29:52 2026	deployed  	wkc-5.3.1+20260225.234930.305	5.3.1      	Upgrade complete
```

Copy the Version 5.3.1 helm chart (ibm-wkc-5.3.1+20260225.234930.305.tgz) to a local location and run the following commands to apply the IKC operator hotfix image override to the IKC helm chart
```
...
For x86 installations
```
helm upgrade wkc cpd-cli-workspace/olm-utils-workspace/work/offline/5.3.1/.ibm-pak/data/cases/ibm-wkc/5.3.1/charts/wkc-5.3.1+20260225.234930.305.tgz --reuse-values --set wkc.operatorImageDigest.amd64=sha256:7b601d78a630904909d310ba46d5bdf64930e059197483f58a7ad68c7292dc4e
```

The helm chart may be downloaded from [here](https://github.com/IBM/charts/blob/master/repo/ibm-helm/wkc-5.3.1%2B20260225.234930.305.tgz) or copied from the local cpd-cli workspace directory
...
REVISION	UPDATED                 	STATUS    	CHART                        	APP VERSION	DESCRIPTION     
1       	Thu Jan  8 17:29:29 2026	superseded	wkc-migration-0.0.0          	0.0.0      	Install complete
2       	Thu Jan  8 17:29:52 2026	superseded	wkc-5.3.1+20260225.234930.305	5.3.1      	Upgrade complete
3       	Thu Jan  8 13:53:11 2026	deployed  	wkc-5.3.1+20260225.234930.305	5.3.1      	Upgrade complete
```
