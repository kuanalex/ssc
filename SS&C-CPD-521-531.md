...
Create the wkc-install-options.yml for IBM Knowledge Catalog - Confirm the values in SS&C cluster via CR yaml
```
################################################################################
...
2       	Thu Jan  8 17:29:52 2026	deployed  	wkc-5.3.1+20251203.234930.305	5.3.1      	Upgrade complete
```

Copy the Version 5.3.1 helm chart (ibm-wkc-5.3.1+20251203.234930.305.tgz) to a local location and run the following commands to apply the IKC operator hotfix image override to the IKC helm chart
```
...
For x86 installations
```
helm upgrade wkc cpd-cli-workspace/olm-utils-workspace/work/offline/5.3.1/.ibm-pak/data/cases/ibm-wkc/5.3.1/charts/wkc-5.3.1+20251203.234930.305.tgz --reuse-values --set wkc.operatorImageDigest.amd64=sha256:7b601d78a630904909d310ba46d5bdf64930e059197483f58a7ad68c7292dc4e
```

The helm chart may be downloaded from [here](https://github.com/IBM/charts/blob/master/repo/ibm-helm/wkc-5.3.1%2B20251203.234930.305.tgz) or copied from the local cpd-cli workspace directory
...
REVISION	UPDATED                 	STATUS    	CHART                        	APP VERSION	DESCRIPTION     
1       	Thu Jan  8 17:29:29 2026	superseded	wkc-migration-0.0.0          	0.0.0      	Install complete
2       	Thu Jan  8 17:29:52 2026	superseded	wkc-5.3.1+20251203.234930.305	5.3.1      	Upgrade complete
3       	Thu Jan  8 13:53:11 2026	deployed  	wkc-5.3.1+20251203.234930.305	5.3.1      	Upgrade complete
```
...
```
helm upgrade datastage-ent <YOUR CPD-CLI WORKSPACE>/olm-utils-workspace/work/offline/5.3.1/.ibm-pak/data/cases/ibm-datastage-enterprise/11.0.0/charts/datastage-ent-11.0.0+20251203.100137.3359.tgz -f values-override.yaml
```
